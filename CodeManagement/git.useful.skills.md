...
[第一次从gerrit拉代码](https://github.com/FrannyZhao/FrannyZhao.github.io/blob/master/CodeManagement/git.useful.skills.md#第一次从gerrit拉代码) <br/>
...
在理解下面的技能前，希望大家先在脑海中形象滴理解下git branch和git commit.把branch理解成一条流水线，把commit理解成乐高积木。branch这条流水线是由一个一个commit积木组成的。
